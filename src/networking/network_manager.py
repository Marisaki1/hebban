...
"""
Network manager for client-side networking integration
"""
...
class NetworkManager:
    """Manages network client and integrates with game"""
    ...
    def __init__(self):
        ...
        self.other_players = {}  # Track other players in game
    ...
    def start(self, server_host: str = "localhost", server_port: int = 8080):
        """Start network manager in separate thread"""
    ...
    async def _connect(self, host: str, port: int):
        ...
        # Connect
        self.is_connected = await self.client.connect(host, port, self.player_id, self.player_name)
    ...
    def create_lobby(self, lobby_code: str):
        ...
        if self.is_connected and self.loop:
            ...
            asyncio.run_coroutine_threadsafe(
                self.client.create_lobby(lobby_code),
                self.loop
            )
