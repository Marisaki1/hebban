...
class Particle:
    ...
    def update(self, delta_time: float) -> bool:
        """Update particle, returns False if should be removed"""
        # Update position
        ...
        self.color = (*self.color[:3], int(self.color[3] * alpha_factor))
...
class ParticleEmitter:
    ...
    def update(self, delta_time: float):
        ...
        # Generate new particles if active
...
class ParticleManager:
    ...
    def create_effect(self, effect_type: str, x: float, y: float) -> Optional[ParticleEmitter]:
        ...
        try:
            ...
            print(f"Unknown particle effect: {effect_type}")
            return None
